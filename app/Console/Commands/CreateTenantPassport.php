...
class CreateTenantPassport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'tenant-passport:client
    ...
    public function handle(ClientRepository $clients): void
    {
        ...
        foreach ($tenants as $tenant) {
            $this->components->info("Creating client for tenant: {$tenant->id}");
        ...
        $this->components->info('Clients created successfully for all tenants.');
    }
